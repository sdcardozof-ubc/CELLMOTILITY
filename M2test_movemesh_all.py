...
def run_simulation(beta1, beta2, save_path):
    ...
    plt.savefig(os.path.join(save_path, f'M2Area{beta1:.3f}_{beta2:.3f}.png'))  # Guarda la figura como archivo PNG
    ...
    plt.tick_params(axis='both', which='major', labelsize=14)  # Aumentar el tamaño de los ticks
    #plt.legend(fontsize=14)
    plt.savefig(os.path.join(save_path, f'M2lambda{beta1:.3f}_{beta2:.3f}.png'))  # Guarda la figura como archivo PNG
...
output_Afile = "MeanCurvature2O/RESULTS/M2/AM2.dat"
...
for beta1 in beta1_values:
        save_path = fr"MeanCurvature2O/RESULTS/M2/resultsb1{beta1:.3f}"
